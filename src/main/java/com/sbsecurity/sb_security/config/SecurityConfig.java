...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, MasterAuthenticationProvider masterAuthenticationProvider, CustomFilter customFilter) throws Exception {
        return http
